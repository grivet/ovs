...
/* nb_user is the number of expected users of the pool, in terms of execution threads. */
struct seq_pool *seq_pool_create(unsigned int nb_user, uint32_t base, uint32_t n_ids);
